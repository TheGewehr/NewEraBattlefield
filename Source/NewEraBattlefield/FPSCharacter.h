...
{
	MWalk      UMETA(DisplayName = "Walking"),
	MSprint    UMETA(DisplayName = "Sprinting"),
	MCrouch    UMETA(DisplayName = "Crouching"),
	MSlide	  UMETA(DisplayName = "Sliding"),
	MVault	  UMETA(DisplayName = "Vaulting")
};
...
{
	LSlide  UMETA(DisplayName = "Slide"),
	LCrouch  UMETA(DisplayName = "Crouch"),
	LIgnore  UMETA(DisplayName = "Ignore")
};
...
UCLASS()
class NEWERABATTLEFIELD_API AFPSCharacter : public ACharacter
{
	GENERATED_BODY()
